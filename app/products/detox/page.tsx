        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              A refreshing blend of herbs that helps in detoxification and supports overall wellness.
            </p>
        ...
        <section className="mt-16">
          <div className="grid lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div
              ...
              style={{
                backgroundImage: "url('/images/detoxchai.png')",
            ...
            <div className="border rounded-2xl p-3 shadow-sm h-full flex flex-col">
              ...
              >
                ...
                <div className="min-w-[300px]">
                  <ReviewCard
                    name="~ Fathima N"
                    review="I start every morning with this detox drink. It feels refreshing."
                  />
                </div>
                ...
                <div className="min-w-[300px]">
                  <ReviewCard
                    name="~ Pradeep Rao"
                    review="Natural ingredients and pleasant taste. Good wellness product."
                  />
                </div>
                ...
                <div className="min-w-[300px]">
                  <ReviewCard
                    name="~ Clara D'Cunha"
                    review="Easy to use and has become part of my daily routine."
                  />
                </div>
