        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Traditionally known to soothe and uplift with the goodness of saffron and spices.
            </p>
    ...
    <div className="grid lg:grid-cols-[1fr_320px] gap-8 p-8 lg:p-10">
      ...
      <div className="flex items-center justify-center">
        <div className="relative w-74 h-74 lg:w-72 lg:h-72 rounded-full overflow-hidden shadow-xl border-4 border-primary/10">
          <Image
            src="/images/m1.png" // change if needed
            alt="Benefits"
            fill
        ...
        <section className="mt-16">
          <div className="grid lg:grid-cols-2 gap-12 items-stretch">
            ...
            <div
              ...
              style={{
                backgroundImage: "url('/images/kahwa.png')",
            ...
            <div className="border rounded-2xl p-3 shadow-sm h-full flex flex-col">
              ...
              >
                ...
                <div className="min-w-[300px]">
                  <ReviewCard
                    name="~ Amina Hussain"
                    review="Authentic Kahwa taste with a beautiful saffron aroma."
                  />
                </div>
                ...
                <div className="min-w-[300px]">
                  <ReviewCard
                    name="~ Venkatesh Pai"
                    review="Premium quality and very relaxing after a long day."
                  />
                </div>
                ...
                <div className="min-w-[300px]">
                  <ReviewCard
                    name="~ Melwyn D'Silva"
                    review="Loved the traditional flavour and rich spices."
                  />
                </div>
